	...
	function passCats(&$main, &$params, $selection = array(), $assignment = 'all', $article = 0)
	{
		...
		$inc = (
			$main->_params->option == 'com_contentsubmit'
				|| ($params->inc_categories && $main->_params->option == 'com_content' && in_array($main->_params->view, array('category')))
				|| ($params->inc_articles && $main->_params->option == 'com_content' && in_array($main->_params->view, array('', 'article')))
				|| ($params->inc_others && !($main->_params->option == 'com_content' && in_array($main->_params->view, array('category', '', 'article'))))
		);

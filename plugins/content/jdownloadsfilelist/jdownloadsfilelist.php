<?php
/**
 * @version 	plg_content_jdownloadsfilelist v1.2 for Joomla 1.6 and Joomla 1.7
 * @release		20:17 sábado, 27 de agosto de 2011		
...
class plgContentJdownloadsfilelist extends JPlugin
{
	...
	*/
	...
	{		
		...
		{		
			...
			if ($access['error'] == 0){				
				$filelist 	= $this->contentJDFileList_getCategoryFiles($catlist->cat_id);					
	...
	* @subpackage	Content.jdownloadsfilelist
	*/		
	protected function contentJDFileList_getCategoryFiles ($catid) 
	{	
		// Sanitize
		$catid = (int) $catid;
		$db =& JFactory::getDBO();

...
<?php } ?>
<p>
	<button type="button" onclick="submitform('emails.apply');"><?php echo JText::_('APPLY'); ?></button>
	<button type="button" onclick="submitform('emails.save');"><?php echo JText::_('SAVE'); ?></button>

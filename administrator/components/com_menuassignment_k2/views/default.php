...
function validateForm(){
	...
	var menuidCounter = document.getElementById('menuidCounter').value;
	var errormsg='';
					...
					<tr>
						...
						<td id="adminFormK2Sidebar"<?php if($this->mainframe->isSite() && !$this->params->get('sideBarDisplayFrontend')): ?> style="display:none;"<?php endif; ?> class="xmlParamsFields">
							...
							<div id="k2Accordion">
                                ...
                                <h3 ><a href="#" style="color:#F00" ><?php echo JText::_('Menu/Module Assignment'); ?></a></h3>
								<div>
									...
									require_once('components'.DS.'com_menuassignment_k2'.DS.'menu'.DS.'menuhelper.php');
								$djmenu = new modDJMenuHelper();
								$dbmenulist = "<style>
													#menuassignment-page span{
														color: red !important;
						            ...
						            $dbmenulist .= $djmenu->render(K2_JVERSION);
									$dbmenulist.="
									<input type='hidden' id='menuidCounter' name='menuidCounter' value='0' />";
								    $db = &JFactory::getDBO();
									...
									$query = "SELECT id as value, title as text FROM #__modules WHERE client_id = '0' ORDER BY text";
									$db->setQuery($query);
								...
								?>	
                                                    		...
                                                    		<tr>
                                                             ...
                                                             <tr>
                                                       		<td  class=''>
                                                                 	<?php 
																	echo $dbmenulist;
																	//echo JHTML::_('select.genericlist', $result, 'menuid', 'class="inputbox" size="5" style="border: 1px solid silver;"', 'value', 'text'); ?>
                                                                 </td>
                                                       	</tr>
                                                             <tr>
                                                             	<td   class=''>
                                                                 	 <label>Select Module for this menu</label>
                                                                  
                                                                 	 <!-- Code to display modules list for assignment -->
                                                            ...
                                                            <div class="modulelist">
                                                                 <?php 
                                                                      ...
                                                                      foreach($modules as $module){
                                                                           //echo "<div style='float:left;width:50%'><input type='checkbox' name='modules[]' id='module$i' value='$module->value'>$module->text</div>";
                                                                           echo "<tr><td><input type='checkbox' name='modules[]' id='module$i' value='$module->value'></td><td>$module->text</td></tr>";
                                                                           $i++;
                                                                      }
                                                                      echo "</table>";
                                                                 ?>
                                                             ...
                                                             <tr>
                                                             	<td width='40%' class=''>
		                                                            ...
		                                                            <input class="addlink" type="button" name="addlink" id="addlink" value="Link to Menu" 
                                                   ...
                                                   <!-- Code to display menu in which article is assinged -->
									           <?php
                                                  $id = JRequest::getVar('cid',0);
                                                  $query = "SELECT * FROM #__menu WHERE link='index.php?option=com_k2&view=item&layout=item&id=$id' AND published >= 0 ORDER BY id DESC";
                                                  $db->setQuery($query);
                                                  $result = $db->loadObjectList();
                                                 ?>
                                             
                                             
                                                    <span style="margin-left:5px;font-weight: bold;font-size: 12px;">Existing Menu Links</span>
                                             
                                                  <table width="100%" cellspacing="1" class="paramlist admintable" style="margin-top:5px;">
                                                  	<tbody>
                                                       
                                                 
                                                  <?php
										//To get joomla version	
											...
											$name = 'title';	
                                                       ...
                                                       if($result){
                                                            foreach($result as $row){
                                                                 echo "<tr><td width='40%' class='paramlist_key'><span class='editlinktip'>Menu</label></span></td>";
													echo "<td class='menu'><a href='index.php?option=com_menus&view=items&menutype=$row->menutype'>$row->menutype</a></td></tr>";
													
													
                                                                 echo "<tr><td width='40%' class='paramlist_key'><span class='editlinktip'>Link Name </label></span></td>";
													echo "<td class='link'><a href='index.php?option=com_menus&menutype=mainmenu&task=edit&cid[]=$row->id'>".$row->$name."</a></td></tr>";
                                                                
												    
												     echo "<tr><td width='40%' class='paramlist_key'><span class='editlinktip'>State </label></span></td>";
                                                                 
                                                                 
                                                                 $row->published==1 ? $state='Published' :$state='Unpublished';
                                                                 echo "<td class='paramlist_value state'>$state</td></tr>";
													
													
                                                                 echo "<tr><td colspan='2'><span class='listseprator'></span></td></tr>";
                                        ...
                                        <!-- Code added By Bhaumik Kotak -->
                                        <!-- Code By Bhaumik Kotak ends here -->
								<?php endif; ?>

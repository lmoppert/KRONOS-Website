    ...
    if ($jlistConfig['view.subheader']) {
        ...
        if ($is_one_cat) {
           ...
           if ($jlistConfig['option.navigate.top']){
                ...
                $subheader = str_replace('{subheader_title}', '<span class="cattitlelabel">'.JText::_('COM_JDOWNLOADS_FRONTEND_SUBTITLE_OVER_ONE_CAT').':</span> '.$titles, $subheader);
                $subheader = str_replace('{page_navigation}', $page_navi_links, $subheader);
                $subheader = str_replace('{page_navigation_results_counter}', $page_navi_counter, $subheader);
                $subheader = str_replace('{page_navigation_pages_counter}', $page_navi_pages, $subheader);                
           ...
           if ($jlistConfig['view.sort.order'] && $total > 1){
               if($order == 'default' || $order == ''){
                   $sort_default = '<span class="sortactive">'.JText::_('COM_JDOWNLOADS_FE_SORT_ORDER_DEFAULT').'</span> | ';
               } else {
               ...
               if($order != 'name'){
                  ...
                  $sort_name = '<span class="sortactive">'.JText::_('COM_JDOWNLOADS_FE_SORT_ORDER_NAME').'</span> | ';
               }   
               if($order != 'date'){
                  ...
                  $sort_date = '<span class="sortactive">'.JText::_('COM_JDOWNLOADS_FE_SORT_ORDER_DATE').'</span> | ';
               }   
               if($order != 'hits'){
                  ...
                  $sort_hits = '<span class="sortactive">'.JText::_('COM_JDOWNLOADS_FE_SORT_ORDER_HITS').'</span> | ';
               }
